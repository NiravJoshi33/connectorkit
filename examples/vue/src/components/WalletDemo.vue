    ...
    <div class="max-w-2xl mx-auto px-4">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600">
          Demonstrating Solana wallet connection with Vue 3 + Headless Client
        </p>
      </div>
...
onMounted(() => {
  ...
  Object.assign(state, {
    ...
    account: currentState.selectedAccount ? {
      ...
      formatted: currentState.selectedAccount?.slice(0, 4) + '...' + currentState.selectedAccount?.slice(-4)
    } : null,
